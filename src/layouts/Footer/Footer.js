...
<footer class="mt-auto w-full max-w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-gray-100">
  ...
  <div class="text-center">
    ...
    <div class="mt-3">
      <p class="text-gray-500 dark:text-neutral-900">Get Connected to my<a class="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="#"> Social Media</a></p>
